...
public class MonitoringLogServiceImplTest {
  ...
  public void shouldLogUserRegistered() {
    ...
    verifyLog(Level.INFO,
        "USER_REGISTERED User '" + hashUtility.hash(USER_ID)
            + "' registered with consent version '1' and hsaId 'HSA_ID', returned status 'AUTHORIZED'");
  }
  ...
  public void shouldLogUserLogin() {
    ...
    verifyLog(Level.INFO,
        "USER_LOGIN Login user '" + hashUtility.hash(USER_ID)
            + "' using scheme 'AUTHENTICATION_SCHEME'");
  }
  ...
  public void shouldLogUserLogout() {
    ...
    verifyLog(Level.INFO,
        "USER_LOGOUT Logout user '" + hashUtility.hash(USER_ID)
            + "' using scheme 'AUTHENTICATION_SCHEME'");
  }
