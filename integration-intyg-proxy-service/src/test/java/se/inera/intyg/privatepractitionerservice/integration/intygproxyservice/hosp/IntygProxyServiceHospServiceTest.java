...
class IntygProxyServiceHospServiceTest {
  ...
  @InjectMocks private IntygProxyServiceHospService intygProxyServiceHospService;
  ...
  class HandleHospCertificationPersonResponse {
    ...
    void shouldReturnResultForHospCertificationPerson() {
      ...
      final var result =
          intygProxyServiceHospService.handleHospCertificationPersonResponseType(
  ...
  class GetHospLastUpdate {
    ...
    void shouldThrowWebServiceExceptionIfIllegalStateExceptionIsCaught() {
      ...
      assertThrows(
          IllegalStateException.class, () -> intygProxyServiceHospService.getHospLastUpdate());
    }
  }
  ...
  class GetHospCredentialsForPersonResponseType {
    ...
    void shouldReturnCredentialsForPerson() {
      ...
      final var result =
          intygProxyServiceHospService.getHospCredentialsForPersonResponseType(PERSON_ID);
