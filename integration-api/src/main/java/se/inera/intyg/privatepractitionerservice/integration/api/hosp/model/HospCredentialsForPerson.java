...
public class HospCredentialsForPerson {
  ...
  @Builder.Default private List<NursePrescriptionRight> nursePrescriptionRight = new ArrayList<>();
  private String healthcareProfessionalLicenseIdentityNumber;
  @Builder.Default private List<String> educationCode = new ArrayList<>();
  @Builder.Default private List<RestrictionDTO> restrictions = new ArrayList<>();
