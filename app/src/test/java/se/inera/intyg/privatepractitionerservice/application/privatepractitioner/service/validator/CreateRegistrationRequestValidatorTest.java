...
class CreateRegistrationRequestValidatorTest {
  ...
  void setUp() {
    ...
    lenient()
        .when(codeSystemRepository.typeOfCareExists(DR_KRANSTEGE_TYPE_OF_CARE))
        .thenReturn(true);
    lenient()
        .when(
    ...
    final var validationHelper = new PrivatePractitionerValidationHelper(codeSystemRepository);
    createRegistrationRequestValidator =
        new CreateRegistrationRequestValidator(privatePractitionerRepository, validationHelper);
  }
  ...
  void shouldThrowExceptionIfPersonIdNull() {
    final var request = kranstegeRegistrationRequest().personId(null).build();
  ...
  void shouldThrowExceptionIfPersonIdBlank() {
    final var request = kranstegeRegistrationRequest().personId("   ").build();
  ...
  void shouldThrowExceptionIfNameNull() {
    final var request = kranstegeRegistrationRequest().name(null).build();
  ...
  void shouldThrowExceptionIfNameBlank() {
    final var request = kranstegeRegistrationRequest().name("   ").build();
  ...
  void shouldThrowExceptionIfPositionNull() {
    final var request = kranstegeRegistrationRequest().position(null).build();
  ...
  void shouldThrowExceptionIfPositionBlank() {
    final var request = kranstegeRegistrationRequest().position("   ").build();
  ...
  void shouldThrowExceptionIfPositionDontExist() {
    final var request = kranstegeRegistrationRequest().position("xx").build();
  ...
  void shouldThrowExceptionIfCareUnitNameNull() {
    final var request = kranstegeRegistrationRequest().careUnitName(null).build();
  ...
  void shouldThrowExceptionIfCareUnitNameBlank() {
    final var request = kranstegeRegistrationRequest().careUnitName("   ").build();
  ...
  void shouldThrowExceptionIfTypeOfCareNull() {
    final var request = kranstegeRegistrationRequest().typeOfCare(null).build();
  ...
  void shouldThrowExceptionIfTypeOfCareBlank() {
    final var request = kranstegeRegistrationRequest().typeOfCare("   ").build();
  ...
  void shouldThrowExceptionIfTypeOfCareDontExist() {
    final var request = kranstegeRegistrationRequest().typeOfCare("xx").build();
  ...
  void shouldThrowExceptionIfHealthcareServiceTypeNull() {
    final var request = kranstegeRegistrationRequest().healthcareServiceType(null).build();
  ...
  void shouldThrowExceptionIfHealthcareServiceTypeBlank() {
    final var request = kranstegeRegistrationRequest().healthcareServiceType("   ").build();
  ...
  void shouldThrowExceptionIfHealthcareServiceTypeDontExist() {
    final var request = kranstegeRegistrationRequest().healthcareServiceType("xx").build();
  ...
  void shouldThrowExceptionIfPhoneNumberNull() {
    final var request = kranstegeRegistrationRequest().phoneNumber(null).build();
  ...
  void shouldThrowExceptionIfPhoneNumberBlank() {
    final var request = kranstegeRegistrationRequest().phoneNumber("   ").build();
  ...
  void shouldThrowExceptionIfEmailNull() {
    final var request = kranstegeRegistrationRequest().email(null).build();
  ...
  void shouldThrowExceptionIfEmailBlank() {
    final var request = kranstegeRegistrationRequest().email("   ").build();
  ...
  void shouldThrowExceptionIfAddressNull() {
    final var request = kranstegeRegistrationRequest().address(null).build();
  ...
  void shouldThrowExceptionIfAddressBlank() {
    final var request = kranstegeRegistrationRequest().address("   ").build();
  ...
  void shouldThrowExceptionIfZipCodeNull() {
    final var request = kranstegeRegistrationRequest().zipCode(null).build();
  ...
  void shouldThrowExceptionIfZipCodeBlank() {
    final var request = kranstegeRegistrationRequest().zipCode("   ").build();
  ...
  void shouldThrowExceptionIfCityNull() {
    final var request = kranstegeRegistrationRequest().city(null).build();
  ...
  void shouldThrowExceptionIfCityBlank() {
    final var request = kranstegeRegistrationRequest().city("   ").build();
  ...
  void shouldThrowExceptionIfMunicipalityNull() {
    final var request = kranstegeRegistrationRequest().municipality(null).build();
  ...
  void shouldThrowExceptionIfMunicipalityBlank() {
    final var request = kranstegeRegistrationRequest().municipality("   ").build();
  ...
  void shouldThrowExceptionIfCountyNull() {
    final var request = kranstegeRegistrationRequest().county(null).build();
  ...
  void shouldThrowExceptionIfCountyBlank() {
    final var request = kranstegeRegistrationRequest().county("   ").build();
