...
class UpdatePrivatePractitionerRequestValidatorTest {
  ...
  void setUp() {
    ...
    PrivatePractitionerValidationHelper validationHelper =
        new PrivatePractitionerValidationHelper(codeSystemRepository);
    updatePrivatePractitionerRequestValidator =
        new UpdatePrivatePractitionerRequestValidator(validationHelper);
  }
  ...
  void shouldThrowExceptionIfPersonIdNull() {
    final var request = kranstegeUpdateRequest().personId(null).build();
  ...
  void shouldThrowExceptionIfPersonIdBlank() {
    final var request = kranstegeUpdateRequest().personId("   ").build();
  ...
  void shouldThrowExceptionIfPositionNull() {
    final var request = kranstegeUpdateRequest().position(null).build();
  ...
  void shouldThrowExceptionIfPositionBlank() {
    final var request = kranstegeUpdateRequest().position("   ").build();
  ...
  void shouldThrowExceptionIfPositionDontExist() {
    final var request = kranstegeUpdateRequest().position("xx").build();
  ...
  void shouldThrowExceptionIfCareUnitNameNull() {
    final var request = kranstegeUpdateRequest().careUnitName(null).build();
  ...
  void shouldThrowExceptionIfCareUnitNameBlank() {
    final var request = kranstegeUpdateRequest().careUnitName("   ").build();
  ...
  void shouldThrowExceptionIfTypeOfCareNull() {
    final var request = kranstegeUpdateRequest().typeOfCare(null).build();
  ...
  void shouldThrowExceptionIfTypeOfCareBlank() {
    final var request = kranstegeUpdateRequest().typeOfCare("   ").build();
  ...
  void shouldThrowExceptionIfTypeOfCareDontExist() {
    final var request = kranstegeUpdateRequest().typeOfCare("xx").build();
  ...
  void shouldThrowExceptionIfHealthcareServiceTypeNull() {
    final var request = kranstegeUpdateRequest().healthcareServiceType(null).build();
  ...
  void shouldThrowExceptionIfHealthcareServiceTypeBlank() {
    final var request = kranstegeUpdateRequest().healthcareServiceType("   ").build();
  ...
  void shouldThrowExceptionIfHealthcareServiceTypeDontExist() {
    final var request = kranstegeUpdateRequest().healthcareServiceType("xx").build();
  ...
  void shouldThrowExceptionIfPhoneNumberNull() {
    final var request = kranstegeUpdateRequest().phoneNumber(null).build();
  ...
  void shouldThrowExceptionIfPhoneNumberBlank() {
    final var request = kranstegeUpdateRequest().phoneNumber("   ").build();
  ...
  void shouldThrowExceptionIfEmailNull() {
    final var request = kranstegeUpdateRequest().email(null).build();
  ...
  void shouldThrowExceptionIfEmailBlank() {
    final var request = kranstegeUpdateRequest().email("   ").build();
  ...
  void shouldThrowExceptionIfAddressNull() {
    final var request = kranstegeUpdateRequest().address(null).build();
  ...
  void shouldThrowExceptionIfAddressBlank() {
    final var request = kranstegeUpdateRequest().address("   ").build();
  ...
  void shouldThrowExceptionIfZipCodeNull() {
    final var request = kranstegeUpdateRequest().zipCode(null).build();
  ...
  void shouldThrowExceptionIfZipCodeBlank() {
    final var request = kranstegeUpdateRequest().zipCode("   ").build();
  ...
  void shouldThrowExceptionIfCityNull() {
    final var request = kranstegeUpdateRequest().city(null).build();
  ...
  void shouldThrowExceptionIfCityBlank() {
    final var request = kranstegeUpdateRequest().city("   ").build();
  ...
  void shouldThrowExceptionIfMunicipalityNull() {
    final var request = kranstegeUpdateRequest().municipality(null).build();
  ...
  void shouldThrowExceptionIfMunicipalityBlank() {
    final var request = kranstegeUpdateRequest().municipality("   ").build();
  ...
  void shouldThrowExceptionIfCountyNull() {
    final var request = kranstegeUpdateRequest().county(null).build();
  ...
  void shouldThrowExceptionIfCountyBlank() {
    final var request = kranstegeUpdateRequest().county("   ").build();
