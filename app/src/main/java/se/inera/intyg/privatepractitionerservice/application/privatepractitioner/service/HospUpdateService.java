...
public interface HospUpdateService {
  ...
  RegistrationStatus updateHospInformation(PrivatlakareEntity privatlakareEntity,
      boolean shouldRegisterInCertifier)
      throws HospUpdateFailedToContactHsaException;

  void checkForUpdatedHospInformation(PrivatlakareEntity privatlakareEntity);
