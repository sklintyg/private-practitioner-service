package se.inera.intyg.privatepractitionerservice.application.web.integration.stub;
...
import se.inera.intyg.privatepractitionerservice.application.web.integration.stub.model.CareProviderStub;
import se.inera.intyg.privatepractitionerservice.application.web.integration.stub.model.CareUnitStub;
import se.inera.intyg.privatepractitionerservice.application.web.integration.stub.model.CredentialInformation;
import se.inera.intyg.privatepractitionerservice.application.web.integration.stub.model.HsaPerson;
import se.inera.intyg.privatepractitionerservice.application.web.integration.stub.model.SubUnitStub;
...
public class HsaServiceStub {
  ...
  public void updateCredentialInformation(CredentialInformation credentialInformation) {
    CredentialInformation information = get(credentialInformation.getHsaId(),
        credentialInformationMap);
    if (information != null) {
