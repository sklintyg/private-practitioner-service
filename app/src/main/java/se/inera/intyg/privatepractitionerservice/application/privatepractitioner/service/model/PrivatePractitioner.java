...
public class PrivatePractitioner {
  ...
  @Setter private String careProviderName;

  @Setter private String position;
  @Setter private String careUnitName;
  private String ownershipType;
  @Setter private String typeOfCare;
  @Setter private String healthcareServiceType;
  @Setter private String workplaceCode;
  ...
  @Setter private String municipality;
  @Setter private String county;

  private String personalPrescriptionCode;
  @Builder.Default private List<Speciality> specialties = List.of();
  @Builder.Default private List<Restriction> restrictions = List.of();
  ...
  public void updateWithHospInformation(HospPerson hosp) {
    ...
    specialties =
        hosp.getSpecialities().stream().filter((Speciality::isPhysicianSpeciality)).toList();
    licensedHealthcareProfessions = hosp.getLicensedHealthcareProfessions();
    restrictions =
        hosp.getRestrictions().stream().filter(Restriction::isRestrictedPhysician).toList();
  }
