...
public class EraseService {
  ...
  public void erasePrivatePractitioner(String careProviderId) {
    ...
    if (privatePractitioner.isEmpty()) {
      log.warn(
          "Could not find private practitioner with hsa-id {}. Nothing was erased.",
          careProviderId);
      return;
    }
    ...
    if (hospRepository.removeFromCertifier(
        privatePractitioner.get(), "Avslutat konto i Webcert.")) {
